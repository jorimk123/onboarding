  ...
  return (
    <div style={{ minHeight: '100vh', display: 'flex', flexDirection: 'column', alignItems: 'center', justifyContent: 'center', background: 'var(--bg)', padding: 16 }}>
      <div style={{ marginBottom: 28, textAlign: 'center' }}>
        {logoUrl ? (
          <img src={logoUrl} alt="" style={{ maxWidth: 64, maxHeight: 56, width: 'auto', height: 'auto', objectFit: 'contain', margin: '0 auto 12px', display: 'block' }} onError={e => { e.target.style.display = 'none'; }} />
        ) : (

...
export const api = {
  ...
  getClients: (archived) => req('GET', `/clients${archived ? '?archived=true' : ''}`),
  ...
  archiveClient: (clientId) => req('POST', `/clients/${clientId}/archive`),
  unarchiveClient: (clientId) => req('POST', `/clients/${clientId}/unarchive`),
